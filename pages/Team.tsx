...
export const Team: React.FC = () => {
  const partners = [
    ...
    { num: "09", title: "Building Inspector", desc: "Provides independent inspections at construction stages and handover, identifying defects and ensuring your new property meets industry standards.", icon: HardHat },
  ];
      ...
      <section className="pb-32 md:pb-48 bg-[#0C0C0B] px-6 relative border-t border-charcoal-800">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {partners.map((partner, index) => (
            <Reveal key={index} delay={index * 50} direction="up" className="h-full [&>div]:h-full">
